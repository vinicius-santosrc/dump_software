        ...
        <ScrollView style={styles.authPage}>
            ...
            <View style={styles.headerPage}>
                <Image
                    ...
                    source={DumpLogo}
                />
                <Text style={styles.textHeader}>Bem-vindo ao Dump! Realize seu cadastro para continuar.</Text>
            </View>
            ...
            <View style={styles.buttonFinish}>
                ...
                >
                    <Text style={styles.btnSign}>Criar conta</Text>
                </TouchableOpacity>
                <View style={styles.bottomAccount}>
                    <Text style={styles.linkContent}>Já tem uma conta? </Text>
                    <TouchableOpacity
                        onPress={() => router.replace("/sign-in")}
                    ><Text style={styles.linkPage}>Entre agora!</Text></TouchableOpacity>
                </View>
            </View>
